package sg.edu.rp.c346.id22024044.lesson_12_demodialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnExercise3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Obtain the UI component in the input.xml layout
                // It needs to be defined as "final", so that it can used in the onClick() method later
                final EditText etNumber1 = viewDialog.findViewById(R.id.editTextNum1);
                final EditText etNumber2 = viewDialog.findViewById(R.id.editTextNum2);
